class Student < ApplicationRecord
  ...
  enum school_year: {2022=> 0, 2023=>1, 2024 => 2, 2025 => 3, 2026 => 4, 2027 =>5, 2027 =>6 }
  ...
  #validates :bac, :releve, :photo, :presence => true, if: -> { current_step == '' }
  ...
  EDITABLE_FIELDS_STEP_1 = [
    ['school_year', "Entrer l'année du bac", 'number'],
