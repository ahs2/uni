...
Apartment.configure do |config|
  ...
  #
  config.excluded_models = %w{ University SchoolYear User ActiveStorage::Attachment ActiveStorage::Blob }
  ...
  #
  # config.tenant_names = lambda{ University.pluck(:slug) }
  ...
  # end
  #
  config.tenant_names = -> { University.pluck :slug }
